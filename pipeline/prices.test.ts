...
describe('toDailySeries', () => {
  it('sorts, collapses to one entry per UTC day, and lets the last value win', () => {
    expect(toDailySeries(fixture.prices)).toEqual([
      ...
      { date: '2024-01-02', price: 44100 },
      { date: '2024-01-03', price: 43000 },
      { date: '2024-01-04', price: 45000 },
      { date: '2024-01-05', price: 46000 },
      { date: '2024-01-06', price: 44500 },
      { date: '2024-01-07', price: 47000 },
      { date: '2024-01-08', price: 46620 },
    ]);
  });
});
